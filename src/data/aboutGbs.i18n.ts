...
export const aboutGbsContent: Record<"en" | "es" | "fr", AboutGbsLocaleContent> = {
  en: {
    ...
    slides: [
      {
        kind: "narrative",
        title: "(1)What is Guillain-Barré Syndrome (GBS)?",
        bodyMd:
      ...
      {
        kind: "narrative",
        title: "(4)What Happens After GBS",
        bodyMd:
      ...
      {
        kind: "narrative",
        title: "(5)What Happens After GBS cont'd",
        bodyMd:
      ...
      {
        kind: "narrative",
        title: "(7)The Slow Road Back: (And Why It's Okay That It's Slow)",
        bodyMd:
